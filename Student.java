...
public class Student {
    ...
    public void setErpNo(String value) { this.erpNo = value; this.erpNoProp.set(value); }
    public SimpleStringProperty erpNoProperty() { return erpNoProp; }

    public String getStudentName() { return studentName; }
    public void setStudentName(String value) { this.studentName = value; this.studentNameProp.set(value); }
    public SimpleStringProperty studentNameProperty() { return studentNameProp; }

    public String getFatherName() { return fatherName; }
    public void setFatherName(String value) { this.fatherName = value; this.fatherNameProp.set(value); }
    public SimpleStringProperty fatherNameProperty() { return fatherNameProp; }

    public String getDob() { return dob; }
    public void setDob(String value) { this.dob = value; this.dobProp.set(value); }
    public SimpleStringProperty dobProperty() { return dobProp; }

    public String getAddress() { return address; }
    public void setAddress(String value) { this.address = value; this.addressProp.set(value); }
    public SimpleStringProperty addressProperty() { return addressProp; }

    public String getCourse() { return course; }
    public void setCourse(String value) { this.course = value; this.courseProp.set(value); }
    public SimpleStringProperty courseProperty() { return courseProp; }

    public String getCenter() { return center; }
    public void setCenter(String value) { this.center = value; this.centerProp.set(value); }
    public SimpleStringProperty centerProperty() { return centerProp; }
    ...
    public void setDoj(String value) { this.doj = value; this.dojProp.set(value); }
    public SimpleStringProperty dojProperty() { return dojProp; }

    public String getCourseDuration() { return courseDuration; }
    public void setCourseDuration(String value) { this.courseDuration = value; this.courseDurationProp.set(value); }
    public SimpleStringProperty courseDurationProperty() { return courseDurationProp; }
    ...
    public void setId(String value) { setStudentId(value); }
    public SimpleStringProperty idProperty() { return studentIdProp; }

    public String getName() { return getStudentName(); }
    public void setName(String value) { setStudentName(value); }
    public SimpleStringProperty nameProperty() { return studentNameProp; }

    public String getMotherName() { return motherName; }
    public void setMotherName(String value) { this.motherName = value; this.motherNameProp.set(value); }
    public SimpleStringProperty motherNameProperty() { return motherNameProp; }

    public String getMobile() { return mobile; }
    public void setMobile(String value) { this.mobile = value; this.mobileProp.set(value); }
    public SimpleStringProperty mobileProperty() { return mobileProp; }

    public String getAltMobile() { return altMobile; }
    public void setAltMobile(String value) { this.altMobile = value; this.altMobileProp.set(value); }
    public SimpleStringProperty altMobileProperty() { return altMobileProp; }

    public String getEmail() { return email; }
    public void setEmail(String value) { this.email = value; this.emailProp.set(value); }
    public SimpleStringProperty emailProperty() { return emailProp; }

    public String getBatch() { return getBatchTime(); }
    public void setBatch(String value) { setBatchTime(value); }
    public SimpleStringProperty batchProperty() { return batchTimeProp; }

    public String getAdmissionDate() { return getDoj(); }
    public void setAdmissionDate(String value) { setDoj(value); }
    public SimpleStringProperty admissionDateProperty() { return dojProp; }

    public String getCompletionDate() { return getCourseDuration(); }
    public void setCompletionDate(String value) { setCourseDuration(value); }
    public SimpleStringProperty completionDateProperty() { return courseDurationProp; }
}
